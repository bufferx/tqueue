...
class BaseError(Exception):
    def __init__(self, msg='Default'):
        ...
        self.e_msg = 'Uncaught Exception: %s' % msg
...
class DBOperationFailure(DBError):
    def __init__(self, msg='OperationFailure'):
        self.e_code = ErrorCode.DB_OPERATION
        self.e_msg = 'DB Empty: %s' % msg
        pass
